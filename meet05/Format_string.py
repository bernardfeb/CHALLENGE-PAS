...
print("1.Inisial : Hei nama saya {nm} umur saya {u} dan memiliki ukuran sepatu {us}" .format( nm = nama, u = umur, us = ukuran_sepatu))

print( "-"*15, ">f.String")
print( f"Dengan f.String : Hei nama saya {nama} umur saya {umur} dan ukuran sepatu {ukuran_sepatu} ")

print("-"*15, "Alignment dengan Format % ")
